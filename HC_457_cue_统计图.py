# -*- coding: utf-8 -*-
"""
Created on Thu Jul 22 17:26:23 2021
...
def power_(epochs):
    ...
    power = tfr_morlet(epochs, freqs=freqs, n_cycles=n_cycles, use_fft=True,
                        return_itc=False, decim=8, n_jobs=1,average=True,picks = ['PO7','PO8'])
    return power
...
for i in range(0,len(filepath),2):
    ...
    a = power_Congruent.__sub__(power_InCongruent)
